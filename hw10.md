...
**Pynq board cluster + Slurm setup is broken at this moment. So skip Part0, Part1. And move on to Part2 and stop after you generate bitstreams (aka do until Step 10).** 
